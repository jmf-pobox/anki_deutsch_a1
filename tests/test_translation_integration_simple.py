...
class TestTranslationLogic:
    ...
    def test_translation_logic_with_mock_service(self) -> None:
        ...
        mock_service.translate_to_english.assert_called_once_with("Ich gehe in die Schule")
...
class TestImageGenerationIntegration:
    ...
    def test_verb_image_generation_flow(self) -> None:
        ...
        def mock_enrich_verb_with_translation(record, translation_service, media_service):
            """Mock verb enrichment with translation."""
            if not record.get("image") and record.get("infinitive") and record.get("example"):
                ...
                if translation_service:
                    try:
                        search_terms = translation_service.translate_to_english(german_example)
                    except Exception:
        ...
        mock_translation.translate_to_english.assert_called_once_with("Ich gehe in die Schule")
    ...
    def test_preposition_image_generation_flow(self) -> None:
        ...
        def mock_enrich_preposition_with_translation(record, translation_service, media_service):
            """Mock preposition enrichment with translation."""
            if (not record.get("image") and 
                record.get("preposition") and 
                record.get("example1")):
        ...
        # Act
        result = mock_enrich_preposition_with_translation(record, mock_translation, mock_media)
    ...
    def test_phrase_image_generation_flow(self) -> None:
        ...
        def mock_enrich_phrase_with_translation(record, translation_service, media_service):
            ...
            if not record.get("image") and record.get("phrase"):
                ...
                if translation_service:
                    try:
                        search_terms = translation_service.translate_to_english(phrase_text)
                    except Exception:
        ...
        # Act
        result = mock_enrich_phrase_with_translation(record, mock_translation, mock_media)
...
class TestExampleSentenceImageGeneration:
    ...
    def test_adjective_uses_example_sentence(self) -> None:
        ...
        def mock_enrich_adjective_with_example(record, translation_service, media_service, image_exists_func):
            ...
            if (not record.get("image") and
                ...
                if not image_exists_func(word):
                    ...
                    record["image"] = f'<img src="existing_image.jpg">'
        ...
        # Act
        result = mock_enrich_adjective_with_example(record, mock_translation, mock_media, mock_image_exists)
        ...
        mock_translation.translate_to_english.assert_called_once_with("Das Haus ist schön")

        # Verify contextual search was used
        mock_media.generate_image.assert_called_once_with("The house is beautiful", "beautiful")
...
class TestPhraseImageOptimization:
    ...
    def test_phrase_image_generation_with_existing_image(self) -> None:
        ...
        def mock_enrich_phrase_optimized(record, translation_service, media_service, image_exists_func):
            ...
            if not record.get("image") and record.get("phrase"):
                ...
                if not image_exists_func(phrase_text):
                    ...
                    record["image"] = f'<img src="existing_phrase_image.jpg">'
        ...
        # Act
        result = mock_enrich_phrase_optimized(record, mock_translation, mock_media, mock_image_exists)
