...
class TestRecordMapper:
    ...
    def test_record_mapper_initialization(self):
    ...
    def test_map_fields_to_record_noun(self, record_mapper):
    ...
    def test_map_fields_to_record_adjective(self, record_mapper):
    ...
    def test_map_fields_to_record_adverb(self, record_mapper):
    ...
    def test_map_fields_to_record_negation(self, record_mapper):
    ...
    def test_map_fields_to_record_unsupported_type(self, record_mapper):
    ...
    def test_map_fields_to_record_insufficient_fields(self, record_mapper):
    ...
    def test_map_csv_row_to_record_noun(self, record_mapper):
    ...
    def test_map_csv_row_to_record_adjective(self, record_mapper):
    ...
    def test_map_csv_row_to_record_adverb(self, record_mapper):
    ...
    def test_map_csv_row_to_record_negation(self, record_mapper):
    ...
    def test_map_csv_row_missing_fields(self, record_mapper):
    ...
    def test_map_csv_row_unsupported_type(self, record_mapper):
    ...
    def test_get_supported_record_types(self, record_mapper):
    ...
    def test_is_supported_record_type(self, record_mapper):
    ...
    def test_validate_fields_for_record_type_valid(self, record_mapper):
    ...
    def test_validate_fields_for_record_type_invalid(self, record_mapper):
    ...
    def test_validate_fields_unsupported_type(self, record_mapper):
    ...
    def test_get_field_names_for_record_type(self, record_mapper):
    ...
    def test_get_field_names_unsupported_type(self, record_mapper):
        """Test getting field names for unsupported type."""
        with pytest.raises(ValueError, match="Unsupported record type: unknown"):
            record_mapper.get_field_names_for_record_type("unknown")

    def test_get_expected_field_count_for_record_type(self, record_mapper):
    ...
    def test_get_expected_field_count_unsupported_type(self, record_mapper):
