...
from langlearn.languages.german.records.factory import BaseRecord, create_record
...
class RecordMapper:
    ...
    def get_field_names_for_record_type(self, record_type: str) -> list[str]:
        ...
        from langlearn.languages.german.records.factory import RECORD_TYPE_REGISTRY
