...
class AnkiRenderSimulator:
    ...
    def detect_rendering_issues(rendered: str) -> List[str]:
        ...
        text_content = AnkiRenderSimulator.CLOZE_PATTERN.sub('[...]', text_content)  # Process cloze
    ...
    def simulate_cloze_card_states(
        ...
        cloze_numbers = sorted(set(int(match[0]) for match in cloze_matches))
